...
echo "#### Create Agent volume in ${AGENT_INBOUND_1_PERSISTENCE}"
# create dir for agent
mkdir -p ${AGENT_INBOUND_1_PERSISTENCE}
...
envsubst < docker-compose.yaml.template.ssl > docker-compose.yaml
